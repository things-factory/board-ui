...
/**
key-value string map value editor element

Example:

  <things-editor-key-values value=${map}>
  </things-editor-key-values>
*/
export default class ThingsEditorKeyValues extends LitElement {
...
customElements.define('things-editor-key-values', ThingsEditorKeyValues)
